...
5) For OpenAI's closed-source models, you have to set up an **Azure OpenAI** connection in Prompt flow. Open Prompt flow on VS Code, scroll all the way down in the left hand side menus to "Connections" and set up the connection. You need OpenAI API key for this. Follow the instructions and remember the name of your connection.
